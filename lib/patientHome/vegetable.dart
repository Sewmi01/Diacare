...
class VegetablesPage extends StatelessWidget {
      ...
      body: SafeArea(
        child: Column(
          children: [
            ...
            const Icon(Icons.eco, color: Colors.greenAccent, size: 70),

            const SizedBox(height: 10),

            Text(
              "Vegetables for $patientName",
                ...
                builder: (context, snapshot) {
                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return _vegItem(items[index].toString(), index + 1);
                    },
                  );
                },
              ),
  ...
  Widget _vegItem(String text, int index) {
    return Container(
