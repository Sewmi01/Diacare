...
class Patientfruits extends StatefulWidget {
  ...
  @override
  State<Patientfruits> createState() => _PatientfruitsState();
}

class _PatientfruitsState extends State<Patientfruits> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        backgroundColor: const Color(0xFF0B0F3B),
        title: Text("Fruits - ${widget.patientName}"),
        actions: [
          IconButton(
          ...
          if (items.isEmpty) {
            return const Center(
              child: Column(
                ...
                children: [
                  Icon(Icons.local_florist, size: 80, color: Colors.white54),
                  SizedBox(height: 10),
                  Text(
                    "No fruits added yet",
